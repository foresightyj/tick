...
export default class Schedule {
    ...
    public static parseCommand(rawCommand: string): Schedule | undefined {
        ...
        if (match) {
            const delta = parseInt(match[1], 10) * Schedule.timeUnitMap[match[2]];
        ...
        if (timeParsed) {
            ...
            return new Schedule(undefined, timeParsed, taskSegment);
        }
    }
